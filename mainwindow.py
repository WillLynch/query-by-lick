...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.midiFileDisplayList = QtWidgets.QListWidget(self.centralwidget)
        self.midiFileDisplayList.setGeometry(QtCore.QRect(20, 150, 191, 341))
        self.midiFileDisplayList.setObjectName("midiFileDisplayList")
        ...
        self.queryButton.setGeometry(QtCore.QRect(140, 510, 75, 23))
        self.queryButton.setObjectName("queryButton")
        self.tableView = QtWidgets.QTableView(self.centralwidget)
        self.tableView.setGeometry(QtCore.QRect(310, 70, 651, 571))
        self.tableView.setObjectName("tableView")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(310, 40, 71, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "Result Set"))
